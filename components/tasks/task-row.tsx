...
export function TaskRow({ task, onUpdate, onDelete }: TaskRowProps) {
  ...
  const [notesLastModified, setNotesLastModified] = useState<Date | null>(null);
  ...
  const handleNotesMetadataLoaded = (hasContent: boolean, lastModified: Date | null) => {
    setHasNotes(hasContent);
    setNotesLastModified(lastModified);
  };
    ...
    <div>
      ...
      >
        ...
        <TaskNotes
          ...
          onMetadataLoaded={handleNotesMetadataLoaded}
        />
