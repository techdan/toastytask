...
export function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Chevron: ({ className, orientation, size, disabled, ...rest }) => {
          ...
          const Icon = orientation ? orientationMap[orientation] ?? ChevronRight : ChevronRight;
          return (
            <Icon
              className={cn("h-4 w-4", disabled && "opacity-40", className)}
              size={size}
